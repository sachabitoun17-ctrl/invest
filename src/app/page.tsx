...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50" style={{ fontFamily: "var(--font-inter)" }}>
      ...
      {/* ── Header ── */}
      <header className="bg-slate-900 text-white px-4 flex items-center gap-3 shrink-0 h-13 shadow-lg" style={{ height: "52px" }}>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Sidebar / full-screen list on mobile */}
        <aside className={`
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-3 pb-20 md:pb-3">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-center py-12 px-4">
                ...
                <div className="text-sm text-slate-400 mt-1 mb-6">Ajoute un bien via le bouton + ou charge des exemples</div>
                <button
                  onClick={handleSeed}
                  disabled={seeding}
